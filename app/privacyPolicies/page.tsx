export default function PrivacyPolicy() {
  return (
    <main>
      ...
      <p>
        Welcome to Ephemeris ("we," "us," or "our"). At Ephemeris, we are
        committed to protecting your privacy and ensuring that your personal
        information is handled in a secure and responsible manner. This Privacy
        Policy outlines our practices concerning the collection, use, and
        disclosure of your personal information in connection with your use of
        the Ephemeris mobile application ("App").
      </p>
      <h2>2. Information We Collect</h2>
      <h3>a. Information You Provide</h3>
      <p>
        When you use Ephemeris, you may choose to provide us with the following
        information:
      </p>
      <ul>
        <li>
          User Profile Information: This may include your name, username, email
          address, profile picture, and other optional information you choose to
          share.
        </li>
        <li>
        ...
        <li>
          ...
          with other users' content, such as leaving comments, likes, or shares.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          App, such as device type, operating system, and unique device
          identifiers.
        </li>
        <li>
          Usage Data: Data about your interactions with the App, including the
          content you view, the features you use, and your interactions with
          other users.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          To communicate with you, such as to respond to your inquiries or send
          you updates about the App.
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          service providers who help us operate, maintain, and improve the App.
        </li>
        <li>
          Legal Requirements: We may disclose your information to comply with
          applicable laws, regulations, legal processes, or government requests.
        </li>
      </ul>
      ...
      <p>
        ...
        effective date of any changes constitutes your acceptance of the revised
        Privacy Policy.
      </p>
      <h2>7. Contact Us</h2>
      <p>
        ...
        <a href="mailto:f.borisjuk@hangerthem.com">f.borisjuk@hangerthem.com</a>
        .
      </p>
      <h2>8. Consent</h2>
      <p>
